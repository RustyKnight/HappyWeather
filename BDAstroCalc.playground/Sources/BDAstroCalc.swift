...
public struct BDAstroCalc {
	...
	public static let obliquityOfEarth = rad * 23.4397
	...
	*/
	public static func daysSinceJan12000 (date: Date) -> Double {
	...
	- returns: An Date that is the given number of hours after the given date.
	
	*/
	public static func hoursLater (date: Date, hours: Double) -> Date {
	...
	*/
	public static func toJulian (date: Date) -> Double {
	...
	*/
	public static func fromJulian (julianDays: Double) -> Date {
	...
	*/
	public static func altitude (hourAngle: Double, latitude: Double, declination: Double) -> Double {
	...
	*/
	public static func azimuth (hourAngle: Double, latitude: Double, declination: Double) -> Double {
	...
	*/
	public static func declination (latitude: Double, longitude: Double) -> Double {
	...
	*/
	public static func rightAscension (latitude: Double, longitude: Double) -> Double {
	...
	*/
	public static func siderealTime (daysSinceJan12000: Double, longitude: Double) -> Double {
	...
	*/
	public static func moonCoordinates (daysSinceJan12000: Double) -> (declination: Double, distance: Double, rightAscension: Double) {
	...
	*/
	public static func moonPosition(date: Date, location: CLLocationCoordinate2D) -> (altitude: Double, azimuth: Double, distance: Double) {
	...
	*/
	public static func moonPhase (date: Date) -> (fractionOfMoonIlluminated: Double, phase: Double, angle: Double) {
	...
	- returns: The rise and set Dates of the moon, if there are any. If the moon is always up for the given date: returns Date.distantFuture() for both rise and set. If the moon is always down for the given date: returns Date.distantPast() for both rise and set.
	
	*/
	public static func moonRiseAndSet (date: Date, location: CLLocationCoordinate2D) -> (rise: Date, set: Date) {
		...
		for i in stride(from: 1.0, to: 25, by: 2) {
	...
	*/
	public static func approximateTransit (julianCycleNumber: Double, longitude: Double, targetHourAngle: Double) -> Double {
	...
	*/
	public static func eclipticLongitude (meanAnomaly: Double) -> Double {
	...
	*/
	public static func hourAngle (altitude: Double, latitude: Double, declination: Double) -> Double {
	...
	*/
	public static func julianCycle (daysSinceJan12000: Double, longitude: Double) -> Double {
	...
	*/
	public static func julianSet (altitude: Double, declination: Double, latitude: Double, longitude: Double, julianCycleNumber: Double, meanAnomaly: Double, meanLongitude: Double) -> Double {
	...
	*/
	public static func julianSolarTransit (approximateTransit: Double, longitude: Double, meanAnomaly: Double) -> Double {
	...
	*/
	public static func solarMeanAnomaly (daysSinceJan12000: Double) -> Double {
	...
	*/
	public static func sunCoordinates (daysSinceJan12000: Double) -> (declination: Double, rightAscension: Double) {
	...
	*/
	public static func sunPosition (date: Date, location: CLLocationCoordinate2D) -> (altitude: Double, azimuth: Double) {
	...
	*/
	public static func sunRiseAndSet (date: Date, location: CLLocationCoordinate2D) -> (rise: Date, set: Date, solarNoon: Date, nadir: Date) {
	...
	- returns: The method returns a dictionary of significant times during the day. Currently returns: sunriseStart, sunriseEnd, sunsetStart, sunsetEnd, dawn, dusk, nauticalDawn, nauticalDusk, nightStart, nightEnd, goldenHourStart, goldenHourEnd. The time are accessed via a String and given as an Date.
	
	*/
	public static func sunSignificantTimes (date: Date, location: CLLocationCoordinate2D) -> [String: Date] {
