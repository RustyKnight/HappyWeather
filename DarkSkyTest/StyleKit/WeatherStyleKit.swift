...
public class WeatherStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfWeatherMoon: UIImage?
        static var weatherMoonTargets: [AnyObject]?
        static var imageOfWeatherCloudy: UIImage?
        static var weatherCloudyTargets: [AnyObject]?
        static var imageOfWeatherPartlyCloudyNight: UIImage?
        static var weatherPartlyCloudyNightTargets: [AnyObject]?
        static var imageOfWeatherFog: UIImage?
        static var weatherFogTargets: [AnyObject]?
    }
    ...
    @objc dynamic public class func drawWeatherMoon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawWeatherCloudy(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 22.5, y: 12))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 22.5), controlPoint1: CGPoint(x: 16.71, y: 12), controlPoint2: CGPoint(x: 12, y: 16.71))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 23), controlPoint1: CGPoint(x: 12, y: 22.66), controlPoint2: CGPoint(x: 11.99, y: 22.83))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 31), controlPoint1: CGPoint(x: 7.59, y: 23), controlPoint2: CGPoint(x: 4, y: 26.59))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 39), controlPoint1: CGPoint(x: 4, y: 35.41), controlPoint2: CGPoint(x: 7.59, y: 39))
        bezierPath.addLine(to: CGPoint(x: 36, y: 39))
        bezierPath.addCurve(to: CGPoint(x: 46, y: 29), controlPoint1: CGPoint(x: 41.52, y: 39), controlPoint2: CGPoint(x: 46, y: 34.52))
        bezierPath.addCurve(to: CGPoint(x: 36, y: 19), controlPoint1: CGPoint(x: 46, y: 23.48), controlPoint2: CGPoint(x: 41.52, y: 19))
        bezierPath.addCurve(to: CGPoint(x: 32.59, y: 19.59), controlPoint1: CGPoint(x: 34.82, y: 19), controlPoint2: CGPoint(x: 33.69, y: 19.2))
        bezierPath.addCurve(to: CGPoint(x: 22.5, y: 12), controlPoint1: CGPoint(x: 31.33, y: 15.12), controlPoint2: CGPoint(x: 27.26, y: 12))
        bezierPath.close()
        white.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawWeatherPartlyCloudyNight(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezier4Path.move(to: CGPoint(x: 20.31, y: 7.97))
        bezier4Path.addCurve(to: CGPoint(x: 20.12, y: 9.28), controlPoint1: CGPoint(x: 20.31, y: 7.97), controlPoint2: CGPoint(x: 20.12, y: 9.28))
        bezier4Path.addCurve(to: CGPoint(x: 20, y: 11), controlPoint1: CGPoint(x: 20.03, y: 9.94), controlPoint2: CGPoint(x: 20, y: 10.49))
        bezier4Path.addCurve(to: CGPoint(x: 21.44, y: 16.69), controlPoint1: CGPoint(x: 20, y: 13.06), controlPoint2: CGPoint(x: 20.52, y: 14.99))
        bezier4Path.addCurve(to: CGPoint(x: 17.01, y: 25.51), controlPoint1: CGPoint(x: 18.85, y: 18.79), controlPoint2: CGPoint(x: 17.15, y: 21.95))
        bezier4Path.addCurve(to: CGPoint(x: 17.01, y: 25.51), controlPoint1: CGPoint(x: 17.01, y: 25.51), controlPoint2: CGPoint(x: 17, y: 25.67))
        bezier4Path.addCurve(to: CGPoint(x: 11.22, y: 32.01), controlPoint1: CGPoint(x: 14.11, y: 26.54), controlPoint2: CGPoint(x: 11.91, y: 29))
        bezier4Path.addCurve(to: CGPoint(x: 7, y: 22), controlPoint1: CGPoint(x: 8.62, y: 29.47), controlPoint2: CGPoint(x: 7, y: 25.92))
        bezier4Path.addCurve(to: CGPoint(x: 19, y: 8.16), controlPoint1: CGPoint(x: 7, y: 15.09), controlPoint2: CGPoint(x: 12.16, y: 9.14))
        bezier4Path.addLine(to: CGPoint(x: 20.31, y: 7.97))
        bezier4Path.addLine(to: CGPoint(x: 20.31, y: 7.97))
        bezier4Path.close()
        white.setFill()
        bezier4Path.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 8, y: 2))
        bezier2Path.addCurve(to: CGPoint(x: 7, y: 3), controlPoint1: CGPoint(x: 7.45, y: 2), controlPoint2: CGPoint(x: 7, y: 2.45))
        bezier2Path.addLine(to: CGPoint(x: 7, y: 4))
        bezier2Path.addLine(to: CGPoint(x: 6, y: 4))
        bezier2Path.addCurve(to: CGPoint(x: 5, y: 5), controlPoint1: CGPoint(x: 5.45, y: 4), controlPoint2: CGPoint(x: 5, y: 4.45))
        bezier2Path.addCurve(to: CGPoint(x: 6, y: 6), controlPoint1: CGPoint(x: 5, y: 5.55), controlPoint2: CGPoint(x: 5.45, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 7, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 7, y: 7))
        bezier2Path.addCurve(to: CGPoint(x: 8, y: 8), controlPoint1: CGPoint(x: 7, y: 7.55), controlPoint2: CGPoint(x: 7.45, y: 8))
        bezier2Path.addCurve(to: CGPoint(x: 9, y: 7), controlPoint1: CGPoint(x: 8.55, y: 8), controlPoint2: CGPoint(x: 9, y: 7.55))
        bezier2Path.addLine(to: CGPoint(x: 9, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 6))
        bezier2Path.addCurve(to: CGPoint(x: 11, y: 5), controlPoint1: CGPoint(x: 10.55, y: 6), controlPoint2: CGPoint(x: 11, y: 5.55))
        bezier2Path.addCurve(to: CGPoint(x: 10, y: 4), controlPoint1: CGPoint(x: 11, y: 4.45), controlPoint2: CGPoint(x: 10.55, y: 4))
        bezier2Path.addLine(to: CGPoint(x: 9, y: 4))
        bezier2Path.addLine(to: CGPoint(x: 9, y: 3))
        bezier2Path.addCurve(to: CGPoint(x: 8, y: 2), controlPoint1: CGPoint(x: 9, y: 2.45), controlPoint2: CGPoint(x: 8.55, y: 2))
        bezier2Path.close()
        white.setFill()
        bezier2Path.fill()
    ...
    @objc dynamic public class func drawWeatherFog(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 8.35, y: 14.08))
        bezierPath.addCurve(to: CGPoint(x: 6.91, y: 15.88), controlPoint1: CGPoint(x: 7.47, y: 14.17), controlPoint2: CGPoint(x: 6.83, y: 14.98))
        bezierPath.addCurve(to: CGPoint(x: 8.64, y: 17.37), controlPoint1: CGPoint(x: 6.99, y: 16.78), controlPoint2: CGPoint(x: 7.77, y: 17.45))
        bezierPath.addLine(to: CGPoint(x: 32.43, y: 17.37))
        bezierPath.addCurve(to: CGPoint(x: 33.83, y: 16.55), controlPoint1: CGPoint(x: 33, y: 17.37), controlPoint2: CGPoint(x: 33.54, y: 17.07))
        bezierPath.addCurve(to: CGPoint(x: 33.83, y: 14.9), controlPoint1: CGPoint(x: 34.11, y: 16.04), controlPoint2: CGPoint(x: 34.11, y: 15.41))
        bezierPath.addCurve(to: CGPoint(x: 32.43, y: 14.08), controlPoint1: CGPoint(x: 33.54, y: 14.39), controlPoint2: CGPoint(x: 33, y: 14.08))
        bezierPath.addLine(to: CGPoint(x: 8.64, y: 14.08))
        bezierPath.addCurve(to: CGPoint(x: 8.49, y: 14.08), controlPoint1: CGPoint(x: 8.59, y: 14.08), controlPoint2: CGPoint(x: 8.54, y: 14.08))
        bezierPath.addCurve(to: CGPoint(x: 8.35, y: 14.08), controlPoint1: CGPoint(x: 8.45, y: 14.08), controlPoint2: CGPoint(x: 8.4, y: 14.08))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 16.28, y: 23.94))
        bezierPath.addCurve(to: CGPoint(x: 14.84, y: 25.73), controlPoint1: CGPoint(x: 15.4, y: 24.02), controlPoint2: CGPoint(x: 14.76, y: 24.83))
        bezierPath.addCurve(to: CGPoint(x: 16.57, y: 27.22), controlPoint1: CGPoint(x: 14.92, y: 26.64), controlPoint2: CGPoint(x: 15.7, y: 27.3))
        bezierPath.addLine(to: CGPoint(x: 40.36, y: 27.22))
        bezierPath.addCurve(to: CGPoint(x: 41.76, y: 26.41), controlPoint1: CGPoint(x: 40.93, y: 27.23), controlPoint2: CGPoint(x: 41.47, y: 26.92))
        bezierPath.addCurve(to: CGPoint(x: 41.76, y: 24.75), controlPoint1: CGPoint(x: 42.04, y: 25.89), controlPoint2: CGPoint(x: 42.04, y: 25.26))
        bezierPath.addCurve(to: CGPoint(x: 40.36, y: 23.94), controlPoint1: CGPoint(x: 41.47, y: 24.24), controlPoint2: CGPoint(x: 40.93, y: 23.93))
        bezierPath.addLine(to: CGPoint(x: 16.57, y: 23.94))
        bezierPath.addCurve(to: CGPoint(x: 16.42, y: 23.94), controlPoint1: CGPoint(x: 16.52, y: 23.94), controlPoint2: CGPoint(x: 16.47, y: 23.94))
        bezierPath.addCurve(to: CGPoint(x: 16.28, y: 23.94), controlPoint1: CGPoint(x: 16.38, y: 23.94), controlPoint2: CGPoint(x: 16.33, y: 23.94))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 8.35, y: 33.79))
        bezierPath.addCurve(to: CGPoint(x: 6.91, y: 35.59), controlPoint1: CGPoint(x: 7.47, y: 33.87), controlPoint2: CGPoint(x: 6.83, y: 34.68))
        bezierPath.addCurve(to: CGPoint(x: 8.64, y: 37.07), controlPoint1: CGPoint(x: 6.99, y: 36.49), controlPoint2: CGPoint(x: 7.77, y: 37.16))
        bezierPath.addLine(to: CGPoint(x: 32.43, y: 37.07))
        bezierPath.addCurve(to: CGPoint(x: 33.83, y: 36.26), controlPoint1: CGPoint(x: 33, y: 37.08), controlPoint2: CGPoint(x: 33.54, y: 36.77))
        bezierPath.addCurve(to: CGPoint(x: 33.83, y: 34.6), controlPoint1: CGPoint(x: 34.11, y: 35.75), controlPoint2: CGPoint(x: 34.11, y: 35.12))
        bezierPath.addCurve(to: CGPoint(x: 32.43, y: 33.79), controlPoint1: CGPoint(x: 33.54, y: 34.09), controlPoint2: CGPoint(x: 33, y: 33.78))
        bezierPath.addLine(to: CGPoint(x: 8.64, y: 33.79))
        bezierPath.addCurve(to: CGPoint(x: 8.49, y: 33.79), controlPoint1: CGPoint(x: 8.59, y: 33.79), controlPoint2: CGPoint(x: 8.54, y: 33.79))
        bezierPath.addCurve(to: CGPoint(x: 8.35, y: 33.79), controlPoint1: CGPoint(x: 8.45, y: 33.79), controlPoint2: CGPoint(x: 8.4, y: 33.79))
        bezierPath.close()
        white.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawHorizonHud(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        context.drawLinearGradient(horizonGradient,
            start: CGPoint(x: rightCompositeRect.minX, y: rightCompositeRect.midY),
            end: CGPoint(x: rightCompositeRect.maxX, y: rightCompositeRect.midY),
            options: [])
        context.restoreGState()
        ...
        context.drawLinearGradient(horizonGradient,
            start: CGPoint(x: leftCompositeRect.maxX, y: leftCompositeRect.midY),
            end: CGPoint(x: leftCompositeRect.minX, y: leftCompositeRect.midY),
            options: [])
        context.restoreGState()
    ...
    @objc dynamic public class var imageOfWeatherMoon: UIImage {
        if Cache.imageOfWeatherMoon != nil {
            return Cache.imageOfWeatherMoon!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 50, height: 50), false, 0)
            WeatherStyleKit.drawWeatherMoon()

        Cache.imageOfWeatherMoon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfWeatherMoon!
    }

    @objc dynamic public class var imageOfWeatherCloudy: UIImage {
        if Cache.imageOfWeatherCloudy != nil {
            return Cache.imageOfWeatherCloudy!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 50, height: 50), false, 0)
            WeatherStyleKit.drawWeatherCloudy()

        Cache.imageOfWeatherCloudy = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfWeatherCloudy!
    }

    @objc dynamic public class var imageOfWeatherPartlyCloudyNight: UIImage {
        if Cache.imageOfWeatherPartlyCloudyNight != nil {
            return Cache.imageOfWeatherPartlyCloudyNight!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 50, height: 50), false, 0)
            WeatherStyleKit.drawWeatherPartlyCloudyNight()

        Cache.imageOfWeatherPartlyCloudyNight = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfWeatherPartlyCloudyNight!
    }

    @objc dynamic public class var imageOfWeatherFog: UIImage {
        if Cache.imageOfWeatherFog != nil {
            return Cache.imageOfWeatherFog!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 50, height: 50), false, 0)
            WeatherStyleKit.drawWeatherFog()

        Cache.imageOfWeatherFog = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfWeatherFog!
    }

    @objc dynamic public class func imageOfHorizonHud(imageSize: CGSize = CGSize(width: 300, height: 300)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(imageSize, false, 0)
            WeatherStyleKit.drawHorizonHud(frame: CGRect(x: 0, y: 0, width: imageSize.width, height: imageSize.height))

        let imageOfHorizonHud = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfHorizonHud
    }
    ...
    @objc @IBOutlet dynamic var weatherMoonTargets: [AnyObject]! {
        get { return Cache.weatherMoonTargets }
        set {
            Cache.weatherMoonTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: WeatherStyleKit.imageOfWeatherMoon)
            }
        }
    }

    @objc @IBOutlet dynamic var weatherCloudyTargets: [AnyObject]! {
        get { return Cache.weatherCloudyTargets }
        set {
            Cache.weatherCloudyTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: WeatherStyleKit.imageOfWeatherCloudy)
            }
        }
    }

    @objc @IBOutlet dynamic var weatherPartlyCloudyNightTargets: [AnyObject]! {
        get { return Cache.weatherPartlyCloudyNightTargets }
        set {
            Cache.weatherPartlyCloudyNightTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: WeatherStyleKit.imageOfWeatherPartlyCloudyNight)
            }
        }
    }

    @objc @IBOutlet dynamic var weatherFogTargets: [AnyObject]! {
        get { return Cache.weatherFogTargets }
        set {
            Cache.weatherFogTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: WeatherStyleKit.imageOfWeatherFog)
            }
        }
    }
