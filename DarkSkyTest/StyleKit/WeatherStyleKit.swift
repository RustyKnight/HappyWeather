...
public class WeatherStyleKit : NSObject {
    ...
    @objc dynamic public class func drawHorizonHud(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300)) {
        ...
        let fillGradient = CGGradient(colorsSpace: nil, colors: [fill.cgColor, UIColor.black.cgColor, transparentFill.cgColor] as CFArray, locations: [0, 0.5, 1])!
        ...
        //// Group 3
        //// Background Drawing
        let backgroundRect = CGRect(x: group3.minX + fastFloor(group3.width * 0.00000 + 0.5), y: group3.minY + fastFloor(group3.height * 0.00000 + 0.5), width: fastFloor(group3.width * 1.00000 + 0.5) - fastFloor(group3.width * 0.00000 + 0.5), height: fastFloor(group3.height * 1.00000 + 0.5) - fastFloor(group3.height * 0.00000 + 0.5))
        let backgroundPath = UIBezierPath(rect: backgroundRect)
        context.saveGState()
        backgroundPath.addClip()
        context.drawLinearGradient(fillGradient,
            start: CGPoint(x: backgroundRect.midX, y: backgroundRect.minY),
            end: CGPoint(x: backgroundRect.midX, y: backgroundRect.maxY),
            options: [])
        context.restoreGState()
